...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { BTNU }]; #IO_L24N_T3_34 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { salida_7seg[7] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
